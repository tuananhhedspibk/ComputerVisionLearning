...
# Creating the list of the transformations (scaling, tensor conversion, normalize)
...
class G(nn.Module):
    def __init__(self):
        ...
        # 100: vector input size
        # 512: feature map output size
        # kernel size will be 4x4
...
for epoch in range(25):
    for i, data in enumerate(dataloader, 0):
        ...
        # Training the discriminator with the fake image generated by generator
